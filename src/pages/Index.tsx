          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-4 leading-relaxed text-muted-foreground">
                Вы получаете то, чего ищет каждый второй мужчина в 25-40 лет: безопасное пространство для разговора, в котором можно быть и сильным, и уязвимым одновременно.
              </p>
              <p className="text-lg mb-4 leading-relaxed text-muted-foreground">
                Во время стрижки — мы говорим о вещах, которые действительно важны. После сеанса — вы видите новое отражение в зеркале и чувствуете ясность в голове.
              </p>
              <p className="text-base mb-8 leading-relaxed text-muted-foreground italic">
                Это не психотерапия. Это лайф-коучинг в контексте создания вашего мужского стиля.
              </p>
      ...
      <section id="about" className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-center">
            Что такое "барбер-психолог"? Формат, который работает
          </h2>
          <div className="max-w-3xl mx-auto text-center mb-12 space-y-4">
            <p className="text-lg text-muted-foreground">Стандартная стрижка — это стрижка.</p>
            <p className="text-lg text-muted-foreground">Психолог в кабинете — это стресс и стигма.</p>
            <p className="text-xl font-semibold">А когда они объединяются?</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-lg font-semibold mb-2">Результат:</p>
            <p className="text-muted-foreground">Улучшение внешнего вида + эмоциональная разгрузка + практические инструменты саморазвития.</p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: "Барбершоп — это мужское пространство. Здесь разговоры звучат естественно, без стресса психиатрического кабинета. Мастер — это не «врач», а партнер в разговоре."
              },
              {
                icon: "Eye",
              ...
              },
              {
                ...
                desc: "82% мужчин избегают психологов, потому что боятся быть названными «больными». Здесь вы просто проходите уход и получаете консультацию — естественно и без ярлыков."
              },
              {
                icon: "Lightbulb",
          ...
          <Card className="mt-8">
            <CardContent className="p-8">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p><strong className="text-foreground">💰 Почему именно такая цена?</strong> Стандартная стрижка во Владивостоке: 1 200-2 000 ₽. Консультация психолога: 3 000-5 000 ₽. Барбер-психолог (60 мин): 3 500 ₽ — это честная цена за обе услуги интегрированно.</p>
                ...
                <p><strong className="text-foreground">📊 Как часто ходить?</strong> Стрижку нужно делать 1 раз в месяц (4-6 недель). Консультацию можно проводить в один день со стрижкой или отдельно. Оптимальный график: барбер-психолог 1 раз в месяц, дополнительные консультации по необходимости.</p>
                <p><strong className="text-foreground">💳 Способы оплаты:</strong> Наличные, Сбербанк, Сбер Пей, Яндекс.Касса</p>
                <p><strong className="text-foreground">⏰ Отмена и перенос:</strong> За 24 часа до сеанса — без штрафов. Менее чем за 24 часа — удерживается 30% от стоимости.</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <div>
                <p className="text-muted-foreground leading-relaxed">
                  И я понял: они ищут не просто стрижку. Они ищут безопасное пространство для разговора.
                </p>
              </div>
              <Card>
                <CardContent className="p-6">
              ...
              <div>
                <h4 className="text-lg font-semibold mb-3">Что я понимаю:</h4>
                <p className="text-muted-foreground leading-relaxed">
                  Я знаю, как это — быть мужчиной в 25-40 лет. 
                  Я знаю про стресс, неуверенность, непонимание с близкими, кризис идентичности. 
                  И я знаю, что на этом этапе нужна поддержка, которая не звучит как "лечение".
                </p>
              </div>
              <div>
                <h4 className="text-lg font-semibold mb-3">Моя позиция:</h4>
                <p className="text-muted-foreground leading-relaxed">
                  Я не претендую на звание психотерапевта (это требует медицинской лицензии). 
                  Я предлагаю лайф-коучинг и консультирование в контексте создания мужского стиля.
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-lg font-semibold mb-2">"Первый раз смущался, но понял — это нормально"</p>
                <p className="text-muted-foreground mb-4 text-sm leading-relaxed">
                  Приходил на обычную стрижку. Потом Михаил спросил: "О чем думаешь?" 
                  Рассказал про стресс на работе. Сначала смущался, но потом понял — это именно то, что нужно было. 
                  Получил конкретные советы по управлению стрессом. Результат: ясность ума и хорошая стрижка.
                </p>
                <p className="text-sm font-medium">Илья, 32 года</p>
                <p className="text-xs text-muted-foreground">IT-специалист</p>
              </CardContent>
            </Card>
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-lg font-semibold mb-2">"Я думал, это просто маркетинг, но это действительно работает"</p>
                <p className="text-muted-foreground mb-4 text-sm leading-relaxed">
                  Жена посоветовала попробовать. Я скептически отнесся. Но на самом деле это уникальный формат. 
                  Не нужно идти в кабинет психолога и стесняться перед незнакомцем. 
                  Здесь всё естественно. Стрижка отличная, советы практические.
                </p>
                <p className="text-sm font-medium">Сергей, 28 лет</p>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-lg font-semibold mb-2">"Наконец-то мужское пространство для открытых разговоров"</p>
                <p className="text-muted-foreground mb-4 text-sm leading-relaxed">
                  В 37 лет понял, что нужна поддержка, но не хотел идти к психологу. 
                  Сеанс у Михаила — это то, что нужно было. Ощущение того, что тебя слышат и понимают. 
                  И никакого морализма. Плюс стрижка супер.
                </p>
                <p className="text-sm font-medium">Максим, 37 лет</p>
                <p className="text-xs text-muted-foreground">Предприниматель</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="item-5" className="bg-card px-6 rounded-lg border">
              <AccordionTrigger className="text-left hover:no-underline">
                Первый раз я просто на стрижку. Можно ли?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground">
                Конечно. Приходите на обычную стрижку за 2 000 ₽. 
                Если захочется более глубокую консультацию, можно перейти на пакет барбер-психолог (3 500 ₽).
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-6" className="bg-card px-6 rounded-lg border">
              <AccordionTrigger className="text-left hover:no-underline">
                Где вы находитесь? Как записаться?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground">
                Центр Владивостока, ул. Посьетская, 23, парикмахерская "Стрижевский". 
                Запись только через Telegram: @misha_prisyaga. 
                Бронирую по расписанию максимум за 2 недели вперед.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-7" className="bg-card px-6 rounded-lg border">
              <AccordionTrigger className="text-left hover:no-underline">
            ...
            <AccordionItem value="item-8" className="bg-card px-6 rounded-lg border">
              <AccordionTrigger className="text-left hover:no-underline">
                Что если я не доволен?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground">
                Если разочарованы — я верну 50% стоимости на первый визит 
                (это обо мне, что я ценю ваше время). 
                Честный диалог — что пошло не так, как улучшить.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
              ...
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">(ориентир: центральный ЖД Вокзал)</p>
                  </div>
                  <div>
                    <h3 className="font-semibold mb-2 flex items-center gap-2">
                    ...
                    <p className="text-muted-foreground text-sm">Рядом есть бесплатная и платная парковка</p>
                  </div>
